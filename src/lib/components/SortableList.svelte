<script lang="ts">
     ...
     * */
    export let onChoose: ((event: SortableEvent) => void) | undefined =
        undefined;
    /**
     * Element is unchosen
     * @type {fn(event: SortableEvent) => void}
     * */
    export let onUnchoose: ((event: SortableEvent) => void) | undefined =
        undefined;
    /**
     * Element dragging started
     * @type {fn(event: SortableEvent) => void}
     * */
    export let onStart: ((event: SortableEvent) => void) | undefined =
        undefined;
    /**
    ...
    export let onSpill: ((event: SortableEvent) => void) | undefined =
        undefined;
    /**
     ...
     * @type {fn(event: SortableEvent) => void}
     * */
    export let onUpdate: ((event: SortableEvent) => void) | undefined =
        undefined;
    /**
     * Element is removed from the list into another list
     * @type {fn(event: SortableEvent) => void}
     * */
    export let onRemove: ((event: SortableEvent) => void) | undefined =
        undefined;
    /**
     * Attempt to drag a filtered element
     * @type {fn(event: SortableEvent) => void}
     * */
    export let onFilter: ((event: SortableEvent) => void) | undefined =
        undefined;
    /**
     ...
     * @type {fn(event: SortableEvent) => void}
     * */
    export let onClone: ((event: SortableEvent) => void) | undefined =
        undefined;
    /**
     ...
     * @type {fn(event: SortableEvent) => void}
     * */
    export let onChange: ((event: SortableEvent) => void) | undefined =
        undefined;
...
<div bind:this={list} data-list-id={listId} class={className}>
    <slot />
</div>
