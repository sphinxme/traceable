<script lang="ts">
    ...
    import { highlightFEventIds } from "../stores";
...
<div
    style:width={calculateTimeLength(start, end, isAllDay) + "px"}
    class=" mr-1"
>
    <HoverCard.Root
        openDelay={100}
    ...
    >
        <HoverCard.Trigger>
            <div
                class="cursor-pointer bg-slate-600 w-full h-1 rounded-full hover:h-2 transition-all duration-100"
            />
        </HoverCard.Trigger>
